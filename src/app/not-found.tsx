...
export default function NotFoundPage() {
  return (
    <div className="container max-w-4xl mx-auto">
      <div className="bg-white/80 backdrop-blur-md rounded-2xl shadow-2xl p-8 md:p-12 flex flex-col md:flex-row items-center gap-8 bg-gradient-to-b from-amber-50 via-amber-100 to-amber-50 p-6">
        <motion.div
          ...
          <div className="relative w-64 h-64 md:w-72 md:h-72">
            <svg viewBox="0 0 200 200" className="w-full h-full">
              ...
              <g transform="translate(138,132) rotate(18)">
                <rect x="0" y="0" width="30" height="6" rx="2" fill="#cbd5e1" />
                <rect
                  x="20"
                  y="-10"
                  width="6"
        ...
        >
          ...
          <p className="mt-4 text-slate-600">
            Izgleda da je recept koji tražite pobegao iz šerpe. Ali mi ćemo vam
            pomoći da ga ponovo pronađete.
          </p>
